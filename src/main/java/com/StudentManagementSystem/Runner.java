...
public class Runner {
	...
	public static void main(String[] args) {
		...
		((Student)s1).showStudentDetails();
		
		s1.updateInformation("7766552233");
		((Student)s1).showStudentDetails();
		
		Person t1=new Teacher("Tejas", 33, "Pune", "8899776655", "1234", "Java programming", 3);
		Person t2=new Teacher("Tejas", 33, "Pune", "8899776655", "1234", "Java programming", 3);
		((Teacher)t1).calculateSalary();
		((Teacher)t1).showTeacherDetails();
		t1.updateInformation("Delhi");
		((Teacher)t1).showTeacherDetails();
